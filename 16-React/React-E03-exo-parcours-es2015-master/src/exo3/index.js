...
// const helloWorld = (elems) => {
//       `<div id="hello-world">
//         <h1>Ce HTML a été généré par ${elems.lang}</h1>
//         <h2>Et affiché avec ${elems.method}</h2>
//       </div>`
// };

// const elems = helloWorld({lang : 'titi', method: 'Gros minet'})
// render(elems)
