...
set DDL_AUTO=create
set DB_URL=jdbc:mariadb://localhost:3307/portail_promotion
...
REM Java arguments
set _JAVA_OPTIONS=-Dspring.datasource.url=%DB_URL% -Dspring.datasource.username=%DB_USERNAME% -Dspring.jpa.hibernate.ddl-auto=%DDL_AUTO% -Dspring.jpa.show-sql=false -Duser.language=en -Dfile.encoding=UTF8
