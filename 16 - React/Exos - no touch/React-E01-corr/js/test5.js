...
const admittedUsers = users.filter(function(person) {
  // if (person.age >= 18 && person.cash >= 20) {
  //   return true;
  // } else if (person.age < 18 && person.cash >= 500) {
  //   return true;
  // } else {
  //   return false;
  // };
  return (person.age >= 18 && person.cash >= 20) || person.cash >= 500;
});
